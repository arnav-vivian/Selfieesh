                    ...
                    <div className="px-3 text-left md:cursor-pointer group ">
                        ...
                        >
                            ...
                            <span className="text-xl md:hidden inline">
                                <ion-icon
                                    name={`${heading === link.name ? <FaCaretDown /> : <FaCaretUp />
                                        }`}
                                ></ion-icon>
                            </span>
                            <span className="text-xl md:mt-1 md:ml-2  md:block hidden group-hover:rotate-180 group-hover:-mt-2 hover:underline">
                                <FaCaretDown />
                            </span>
                        </h1>
                        {link.submenu && (
